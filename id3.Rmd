...
## Conditional Entropy
A separate formula was provided for conditional entropy.
Here I take subsets of our data based on the conditioning attribute. (ie. partitioning)
For each occurring value of our conditioning attribute I calculate it's frequency (probability) in the dataset, and multiply that by the entropy of the conditioned attribute in the subset.
...
The current ID3 implementation favors attributes with more occurring values.
